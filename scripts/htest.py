...
from PyQt5.QtGui import QPalette, QBrush, QFont, QFontMetrics, QPainter, QTransform, QColor
from PyQt5.QtWidgets import QHeaderView, QStyleOptionHeader, QStyle, QWidget, QApplication, QTableView, QVBoxLayout
...
if __name__ == "__main__":
    ...
    view = QTableView()
    QVBoxLayout(form).addWidget(view)
    form.show()
    ...
    view.horizontalHeader().setSectionsMovable(True)  # reorder DataFrame columns manually
