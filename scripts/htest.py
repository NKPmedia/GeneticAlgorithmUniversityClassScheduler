...
from PyQt5.QtGui import QBrush, QPalette, QFontMetrics, QFont, QPainter, QTransform
from PyQt5.QtWidgets import QHeaderView, QStyleOptionHeader, QStyle, QWidget, QTableView, QVBoxLayout, QApplication
