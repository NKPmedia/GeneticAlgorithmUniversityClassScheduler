...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btnInstrAdd.setText(_translate("MainWindow", "Referent hinzufügen"))
        self.btnInstrImport.setText(_translate("MainWindow", "Import from CSV"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tabInstructors), _translate("MainWindow", "Referenten"))
        self.groupBox_2.setTitle(_translate("MainWindow", "Operation"))
        self.btnRoomAdd.setText(_translate("MainWindow", "Raum hinzufügen"))
        self.btnRoomImport.setText(_translate("MainWindow", "Import from CSV"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tabRooms), _translate("MainWindow", "Räume"))
        self.groupBox_3.setTitle(_translate("MainWindow", "Operation"))
        self.btnSubjAdd.setText(_translate("MainWindow", "Einheit hinzufügen"))
        self.btnSubjImport.setText(_translate("MainWindow", "Import from CSV"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tabSubjects), _translate("MainWindow", "Einheiten"))
        self.groupBox_4.setTitle(_translate("MainWindow", "Operation"))
        self.btnSecAdd.setText(_translate("MainWindow", "Kurs hinzufügen"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tabSections), _translate("MainWindow", "Kurse"))
